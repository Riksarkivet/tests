...
#   When they change language to Swedish
...
#    And they change language to Swedish
...
Scenario: Viewer user switches language using the toggle button
  Given the user is viewing the Viewer in English with Swedish as secondary locale
   When they click the locale toggle button
   Then the locale toggle button reads EN

Scenario: Viewer user switches language using the toggle button
  Given the user is viewing the Viewer in Swedish with English as secondary locale
   When they click the locale toggle button
   Then the locale toggle button reads SV
